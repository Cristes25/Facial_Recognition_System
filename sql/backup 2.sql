...
-- pull this shit
create view student_image_info_test as SELECT si.student_picture, Concat(st.student_firstname, " ", st.student_lastName) as student_name from student_images si 
